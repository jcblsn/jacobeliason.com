...
To start with, I bought a HP ProDesk 600 G5 Mini (Intel i5-9500T, 16GB RAM, 512GB HDD) on eBay for ~$150. This seems like a [reasonable price](https://www.ebay.com/sch/i.html?_from=R40&_nkw=HP+ProDesk+600+G5+Mini&_sacat=0&RAM%2520Size=16%2520GB&Processor=Intel%2520Core%2520i5%25209th%2520Gen%252E&_oaa=1&LH_Sold=1&LH_Complete=1&rt=nc&Hard%2520Drive%2520Capacity=512%2520GB&_dcat=179) for a capable machine that's small and energy efficient. There are obviously many options; I wanted something more powerful than a Raspberry Pi but less expensive than a workstation.
...
The following were some concepts I unfamiliar with or only somewhat familiar with before starting. This isn't meant to be a comprehensive guide as much as it is a subset of what I personally learned this weekend (mostly from ChatGPT).
