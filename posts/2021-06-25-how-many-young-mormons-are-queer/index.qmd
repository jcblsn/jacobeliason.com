...
```{r, echo = F, message = F}
target_summary <- read_csv("../../../personal-projects/nationscape/DATA/mormon_weight_summary.csv")
...
```{r echo = F, message = F}
target_performance <- read_csv("../../../personal-projects/nationscape/DATA/mormon_weight_performance.csv")
...
```{r echo = F, message = F}
new_estimate <- read_csv("../../../personal-projects/nationscape/DATA/new_est_orientation_by_gen.csv")
...
responses_full <- 
  read_rds(
    "../../../personal-projects/nationscape/DATA/responses_full.rds"
  )

responses_mormon <- 
  read_rds(
    "../../../personal-projects/nationscape/DATA/responses_mormon.rds"
  )
